export type IssueStatus = 'new' | 'in_progress' | 'awaiting_customer' | 'resolved' | 'closed'
...
export type ReportType = 'issues_summary' | 'team_performance' | 'customer_satisfaction' | 'resolution_times'
