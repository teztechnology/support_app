...
export const UpdateIssueSchema = z.object({
  ...
  status: z.enum(['new', 'in_progress', 'awaiting_customer', 'resolved', 'closed']).optional(),
...
export const IssueFilterSchema = z.object({
  status: z.array(z.enum(['new', 'in_progress', 'awaiting_customer', 'resolved', 'closed'])).optional(),
